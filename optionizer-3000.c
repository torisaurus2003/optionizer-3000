...
int main(int argc, char *argv[]) {
	...
	//Create application
	app.application = gtk_application_new("com.torisaurus.optionizer-3000", G_APPLICATION_DEFAULT_FLAGS);
